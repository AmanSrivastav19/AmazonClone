                ...
                <div className='cart_container'>
                    ...
                    <div className='right_cart'>
                        ...
                        <div className='discount_box'>
                            <h5>Discount  : <span style={{ color: "black" }}>{inddata.discount}</span></h5>
                            <h4>Free Delivery  : <span style={{ color: "black", fontWeight: 600 }}>Oct 8 - 21</span>Details</h4>
                            <p>Fatest delivery : <span style={{ color: "black", fontWeight: 600 }}>Tomorrow 11AM</span> </p>

                        </div>
                        <p className='description'>About The Items : <span style={{ color: "#565959", fontSize: 14, fontWeight: 500, letterSpacing: "0.4px" }}>
                            {inddata.description}
                        </span></p>
